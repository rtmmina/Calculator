...
{
    [TestClass]
    public class TestCalculatorGenericsForIntegers
    {
        ...
        public TestCalculatorGenericsForIntegers()
        {
            _configuration = InitConfiguration();
            ILog _log = new Log(_configuration);
            _calculator = new Calculator<int>(_log, _configuration);
        }

        public TestCalculatorGenericsForIntegers(ICalculator<int> intergerCalculator)
        {
            _configuration = InitConfiguration();
